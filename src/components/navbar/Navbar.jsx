                  ...
                  <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://media.licdn.com/dms/image/v2/D4D35AQEEdQ9GVEEQIw/profile-framedphoto-shrink_400_400/profile-framedphoto-shrink_400_400/0/1691514195221?e=1740812400&v=beta&t=gT5rrI9IlQ5dpiGIXjqua8StsPheCB5-yyFgprMDcZY"
                        // src="../../assets/react "
                        alt="user-img" />
                      </Link>
                  </div>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-pink-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          <marquee behavior="" direction="" scrollamount="10">
            Welcome to Electronic Bharat 🙏  &ensp; | &ensp; 
            Get free delivery on orders over ₹300  &ensp; | &ensp; 
